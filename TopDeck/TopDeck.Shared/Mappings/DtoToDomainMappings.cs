...
public static class DtoToDomainMappings
{
    ...
    public static Deck ToDomain(this DeckOutputDTO dto)
    {
        ...
        var baseDeck = new Deck(
            ...
            dto.Name,
            dto.Code,
            (dto.Cards ?? Array.Empty<CardRefDTO>()).Select(c => new CardRef(c.CollectionCode, c.CollectionNumber)).ToList(),
    ...
    public static DeckSuggestion ToDomain(this DeckSuggestionOutputDTO dto)
    {
        ...
        var suggestion = new DeckSuggestion(
            ...
            deck,
            (dto.AddedCards ?? Array.Empty<CardRefDTO>()).Select(c => new CardRef(c.CollectionCode, c.CollectionNumber)).ToList(),
            (dto.RemovedCards ?? Array.Empty<CardRefDTO>()).Select(c => new CardRef(c.CollectionCode, c.CollectionNumber)).ToList(),
