...
public static class DtoToDomainMappings
{
    ...
    public static Deck ToDomain(this DeckOutputDTO dto)
    {
        ...
        var baseDeck = new Deck(
            ...
            dto.Name,
            dto.Code,
            (dto.Cards ?? Array.Empty<DeckCardOutputDTO>()).Select(c => new CardRef(c.CollectionCode, c.CollectionNumber)).ToList(),
            (dto.Cards ?? Array.Empty<DeckCardOutputDTO>()).Where(c => c.IsHighlighted).Select(c => new CardRef(c.CollectionCode, c.CollectionNumber)).ToList(),
    ...
    public static DeckSuggestion ToDomain(this DeckSuggestionOutputDTO dto)
    {
        ...
        var suggestion = new DeckSuggestion(
            ...
            deck,
            (dto.AddedCards ?? Array.Empty<DeckCardOutputDTO>()).Select(c => new CardRef(c.CollectionCode, c.CollectionNumber)).ToList(),
            (dto.RemovedCards ?? Array.Empty<DeckCardOutputDTO>()).Select(c => new CardRef(c.CollectionCode, c.CollectionNumber)).ToList(),
