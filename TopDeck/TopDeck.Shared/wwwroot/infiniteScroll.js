(function(){
    ...
    window.TopDeck.registerInfiniteScroll = function(dotnetRef, selectorOrThreshold, maybeThreshold){
        ...
        const th = hasSelector ? (typeof maybeThreshold === 'number' ? maybeThreshold : 300)
            : (typeof selectorOrThreshold === 'number' ? selectorOrThreshold : 300);
        ...
        // ⚠️ On ne déclenche plus handler() automatiquement ici
    };
    ...
    window.TopDeck.canScroll = function(selectorOrThreshold, maybeThreshold){
        ...
        const th = hasSelector ? (typeof maybeThreshold === 'number' ? maybeThreshold : 0)
            : (typeof selectorOrThreshold === 'number' ? selectorOrThreshold : 0);
